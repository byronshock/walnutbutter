...
Driver: `walnutbutter --goo --eligibility perturb --seeds 10 --seed 1 --input-seed 1 --epochs 250000 --engine arrays`, once per arm; report: `docs/goo-250k-report.py --name goo-250k --eligibility perturb --source seeds`; figure: `goo-250k-score.png`. Every run's trace and summary is under `runs/goo-250k/` (not in git).
