...
walnutbutter --problem copy             # 4 bits complement-coded onto 8 input neurons, and the 8 outputs taught to show exactly that, place for place, unpermuted (AUTHORITY.md §8; the goo task)
